class ReservationsController < ApplicationController
    ...
    private
      def reservation_params
        params.require(:reservation).permit(:start_date, :end_date, :number_of_people, :@room_name, :@user_id, :@room_image_name)
      end

      def permit_params
        @attr = params.permit(:start_date, :end_date, :number_of_people, :@room_name, :@user_id, :@room_image_name)
      end
    end